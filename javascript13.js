...
function memoria_gehitu() {
	      x=x-(memoria*(-1)); //resolver raíz cuadrada.
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
      }
function memoria_kendu() {
	      x=x-memoria; //resolver raíz cuadrada.
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
      }
...
function memoria_c() {
	      memoria=pantalla.innerHTML; //resolver raíz cuadrada.
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
      }
function memoria_r() {
	      x=memoria; //resolver raíz cuadrada.
         pantalla.innerHTML=x; //mostrar en pantalla resultado
         op="no"; //quitar operaciones pendientes.
         xi=1; //se puede reiniciar la pantalla 
      }
